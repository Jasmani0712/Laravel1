    ...
    <body>
        ...
        <section class="container" id="portfolio">
            <div class="row justify-content-center mb-5"><!--creo que no funciona el justify sin -center/ mb-0 o nada para que la imagen este pegado a la siguiente seccion-->
                ...
                @foreach ($post as $projects)
                <div class="col-md-4 col-12 justify-content-center mt-5"> <!--en col 3 sale 4 filas en col 4 sale 3 y en col5 sale 2 filas -->
                   <div class="card m-auto" style="width: 18rem;">
                       <img src="{{asset('/images/portfolio/'.$post->featured)}}" class="card-img-top" alt="{{$projects->title}}">
                        <div class="card-body">
                            <h3 class="card-title my-2">{{$post->title}}</h3>
                            <div class="d-card-text" style="color: red; columns: 12;">
