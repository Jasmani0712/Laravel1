    ...
    <body>
        <nav class="navbar navbar-expand-md d-flex">
                    ...
                    <a class="navbar-brand mr-auto" href="http://localhost:81/AwesomeProject/public/portfolio">
                        <img class="d-block" width="43px" src="images/logoswebstarlab-09.png" alt="First slide">
                    </a>
        ...
        <section class="container" id="about">
            <div class="row justify-content mb-0"><!--creo que no funciona el justify sin -center/ mb-0 o nada para que la imagen este pegado a la siguiente seccion-->
                <div class="col-12 text-center mt-5">
                    <h2>¿Quienes Somos?</h2>
                    <hr>
                </div>
                <div class="col-3 text-center mt-5"> <!--en col 3 sale 4 filas en col 4 sale 3 y en col5 sale 2 filas -->
